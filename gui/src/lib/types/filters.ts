...
export interface PuppetFilters {
	hpMin: number | null;
	hpMax: number | null;
	foAtkMin: number | null;
	foAtkMax: number | null;
	foDefMin: number | null;
	foDefMax: number | null;
	spAtkMin: number | null;
	spAtkMax: number | null;
	spDefMin: number | null;
	spDefMax: number | null;
	spdMin: number | null;
	spdMax: number | null;
	bstMin: number | null;
	bstMax: number | null;
...
export const STAT_FILTER_RANGE: Record<
	StatColumn,
	[keyof PuppetFilters, keyof PuppetFilters]
> = {
	hp: ['hpMin', 'hpMax'],
